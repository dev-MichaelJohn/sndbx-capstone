...
export const ROLE_PERMISSION_MATRIX: Record<RoleName, Permission[]> = {
  ...
  [SYSTEM_ROLES.FACULTY]: [PERMISSIONS.CLASS_READ, PERMISSIONS.EVALUATION_VIEW_OWN_RESULTS],

  [SYSTEM_ROLES.STUDENT]: [PERMISSIONS.CLASS_READ, PERMISSIONS.EVALUATION_SUBMIT_SET],
};
