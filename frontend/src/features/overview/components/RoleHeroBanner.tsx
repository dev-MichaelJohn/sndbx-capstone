...
export const RoleHeroBanner: React.FC<RoleHeroBannerProps> = ({
  ...
  return (
    <div className="flex flex-col gap-2.5 rounded-2xl border border-primary/20 bg-linear-to-r from-primary/10 via-primary/5 to-background p-6 shadow-2xs">
      <div className="flex flex-wrap items-center gap-2">
        <Badge
          variant="outline"
          className={`gap-1.5 text-xs font-semibold px-2.5 py-0.5 ${meta.color}`}
        >
        ...
        {activeTerm && (
          <Badge variant="outline" className="gap-1 font-mono text-xs text-foreground bg-card">
